    ...
    <header class="sticky top-0 z-50 bg-white shadow-sm transition-all duration-300">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <div class="flex items-center space-x-2">
                ...
                <h1 class="text-xl font-bold text-neutral">篮球鞋推荐系统</h1>
            </div>
            <div class="hidden md:flex items-center space-x-6">
                <button id="lang-zh" class="px-3 py-1 rounded-md bg-primary/10 text-primary font-medium">中文</button>
                <button id="lang-ja" class="px-3 py-1 rounded-md hover:bg-gray-100 transition-colors">日本語</button>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white border-t">
            <div class="container mx-auto px-4 py-2">
                <div class="flex justify-around py-2">
                    ...
                    <button id="mobile-lang-ja" class="px-3 py-1 rounded-md hover:bg-gray-100 transition-colors">日本語</button>
        ...
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-xl overflow-hidden">
                ...
                <form id="basic-info-form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="foot_type" name="foot_type" class="select-field" required>
                            ...
                            <option value="高足弓" data-i18n-option="high_arch">高足弓</option>
                            <option value="扁平足" data-i18n-option="flat_foot">扁平足</option>
                            <option value="宽脚" data-i18n-option="wide_foot">宽脚</option>
                            <option value="无所谓" data-i18n-option="no_preference">无所谓</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="favorite_player" name="favorite_player" class="select-field" required>
                            <option value="" disabled selected></option>
                            <option value="迈克尔·乔丹" data-i18n-option="michael_jordan">迈克尔·乔丹</option>
                            ...
                            <option value="斯蒂芬·库里" data-i18n-option="stephen_curry">斯蒂芬·库里</option>
                            <option value="凯文·杜兰特" data-i18n-option="kevin_durant">凯文·杜兰特</option>
                            <option value="詹姆斯·哈登" data-i18n-option="james_harden">詹姆斯·哈登</option>
                            <option value="达米安·利拉德" data-i18n-option="damian_lillard">达米安·利拉德</option>
                            <option value="姚明" data-i18n-option="yao_ming">姚明</option>
                            <option value="林书豪" data-i18n-option="jeremy_lin">林书豪</option>
                            <option value="其他" data-i18n-option="other">其他</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                        <div id="other_player_container" class="hidden mt-3">
                            <input type="text" id="other_player" name="other_player" class="input-field" placeholder="请输入其他球员名字">
                        </div>
                    </div>
                </form>
            ...
            <div id="step-2" class="step-container p-6 md:p-10 hidden">
                ...
                <div id="beginner-questions" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="desired_position" name="desired_position" class="select-field">
                            ...
                            <option value="小前锋" data-i18n-option="small_forward">小前锋</option>
                            <option value="大前锋" data-i18n-option="power_forward">大前锋</option>
                    ...
                    <div>
                        ...
                        <select id="admire_style" name="admire_style" class="select-field">
                            ...
                            <option value="强硬的防守" data-i18n-option="tough_defense">强硬的防守</option>
                            <option value="全面均衡的表现" data-i18n-option="well_rounded">全面均衡的表现</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="scoring_desire" name="scoring_desire" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="成为主要得分手" data-i18n-option="primary_scorer">成为主要得分手</option>
                            <option value="偶尔得分，主要配合" data-i18n-option="occasional_scorer">偶尔得分，主要配合</option>
                    ...
                    <div>
                        ...
                        <select id="defense_interest" name="defense_interest" class="select-field">
                            ...
                            <option value="不太感兴趣，更关注进攻" data-i18n-option="offense_focused">不太感兴趣，更关注进攻</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="team_play" name="team_play" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="团队配合，分享球权" data-i18n-option="team_oriented">团队配合，分享球权</option>
                            <option value="个人表现，承担责任" data-i18n-option="individual_oriented">个人表现，承担责任</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="playing_frequency" name="playing_frequency" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="每周1-2次" data-i18n-option="1_2_times">每周1-2次</option>
                            <option value="每周3-4次" data-i18n-option="3_4_times">每周3-4次</option>
                    ...
                    <div>
                        ...
                        <select id="basketball_goal" name="basketball_goal" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="锻炼身体，娱乐消遣" data-i18n-option="exercise_entertainment">锻炼身体，娱乐消遣</option>
                ...
                <div id="non-beginner-questions" class="space-y-6 hidden">
                    <h4 class="text-lg font-semibold mb-4" data-i18n="non_beginner_questions">篮球经验与风格</h4>
                    ...
                    <div>
                        ...
                        <select id="offensive_strength" name="offensive_strength" class="select-field">
                            ...
                            <option value="无球跑动和空切" data-i18n-option="off_ball">无球跑动和空切</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="defensive_strength" name="defensive_strength" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="贴身防守和抢断" data-i18n-option="on_ball_defense">贴身防守和抢断</option>
                            <option value="盖帽和篮板" data-i18n-option="blocking_rebounding">盖帽和篮板</option>
                            <option value="团队防守和协防" data-i18n-option="team_defense">团队防守和协防</option>
                            <option value="防守意识和预判" data-i18n-option="defensive_awareness">防守意识和预判</option>
                            <option value="全场紧逼" data-i18n-option="full_court_pressure">全场紧逼</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="play_style" name="play_style" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="快节奏进攻" data-i18n-option="fast_paced">快节奏进攻</option>
                            <option value="半场阵地战" data-i18n-option="half_court">半场阵地战</option>
                            <option value="身体对抗强" data-i18n-option="physical_play">身体对抗强</option>
                            <option value="技巧型打法" data-i18n-option="skillful_play">技巧型打法</option>
                            <option value="团队配合型" data-i18n-option="team_play_style">团队配合型</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="court_role" name="court_role" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="主要得分手" data-i18n-option="primary_scorer_role">主要得分手</option>
                            <option value="组织者/控球手" data-i18n-option="playmaker">组织者/控球手</option>
                            ...
                            <option value="全能型球员" data-i18n-option="all_around">全能型球员</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="frequency" name="frequency" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="1-2次" data-i18n-option="1_2_times_week">1-2次</option>
                            <option value="3-4次" data-i18n-option="3_4_times_week">3-4次</option>
                            <option value="5-6次" data-i18n-option="5_6_times_week">5-6次</option>
                    ...
                    <div>
                        ...
                        <select id="improvement_area" name="improvement_area" class="select-field">
                            <option value="" disabled selected></option>
                            <option value="投篮准确性" data-i18n-option="shooting_accuracy">投篮准确性</option>
                            <option value="控球和突破" data-i18n-option="dribbling_driving">控球和突破</option>
                            ...
                            <option value="篮球智商和决策" data-i18n-option="basketball_iq">篮球智商和决策</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="mt-10 flex justify-between">
                    <button id="prev-step-2" class="btn-secondary">
                        ...
                        <span data-i18n="previous">上一步</span>
                    </button>
                ...
                <form id="shoe-preferences-form" class="space-y-6">
                    <div>
                        ...
                        <select id="court_type" name="court_type" class="select-field" required>
                            <option value="" disabled selected></option>
                            <option value="室内木地板" data-i18n-option="indoor_court">室内木地板</option>
                            <option value="室外水泥地" data-i18n-option="outdoor_court">室外水泥地</option>
                            <option value="两者皆有" data-i18n-option="both_courts">两者皆有</option>
                            <option value="不清楚/不知道" data-i18n-option="not_sure">不清楚/不知道</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="price_range" name="price_range" class="input-field pl-10" placeholder="500,1500 或 0表示无预算限制">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500">
                                <i class="fa fa-yuan"></i>
                            </div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1" data-i18n="price_note">如果没有明确预算，请输入0表示无预算限制</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="feature-2" name="shoe_features" value="支撑稳定性" class="checkbox-input">
                                <label for="feature-2" class="text-base font-medium text-gray-700" data-i18n-option="support_stability">支撑稳定性</label>
                            </div>
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="feature-3" name="shoe_features" value="轻便灵活性" class="checkbox-input">
                                <label for="feature-3" class="text-base font-medium text-gray-700" data-i18n-option="lightweight_flexibility">轻便灵活性</label>
                            </div>
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="feature-4" name="shoe_features" value="耐磨耐用性" class="checkbox-input">
                                <label for="feature-4" class="text-base font-medium text-gray-700" data-i18n-option="durability">耐磨耐用性</label>
                            </div>
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="feature-5" name="shoe_features" value="抓地力" class="checkbox-input">
                                <label for="feature-5" class="text-base font-medium text-gray-700" data-i18n-option="traction">抓地力</label>
                            </div>
                            <div class="flex items-center space-x-3">
                                <input type="checkbox" id="feature-6" name="shoe_features" value="透气性" class="checkbox-input">
                                <label for="feature-6" class="text-base font-medium text-gray-700" data-i18n-option="breathability">透气性</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="shoe_brand" name="shoe_brand" class="select-field">
                            ...
                            <option value="安德玛/Under Armour" data-i18n-option="under_armour">安德玛/Under Armour</option>
                        ...
                        <div class="flex flex-col md:flex-row items-center md:items-start">
                            <div class="w-full md:w-1/2 mb-6 md:mb-0 md:pr-6">
                                <div class="text-center md:text-left">
                                    ...
                                    <p id="primary-style-result" class="text-2xl font-bold text-primary">全能均衡型</p>
                                </div>
                            </div>
    ...
    <footer class="bg-neutral text-white py-8 mt-12">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    <div class="flex items-center space-x-2">
                        ...
                        <h2 class="text-xl font-bold">篮球鞋推荐系统</h2>
                    </div>
            ...
            <div class="border-t border-gray-700 mt-6 pt-6 text-center text-gray-400 text-sm">
                <p data-i18n="copyright">© 2023 篮球鞋推荐系统. 保留所有权利。</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        const translations = {
            "zh": {
                ...
                "non_beginner_questions": "篮球经验与风格",
                ...
                "price_note": "如果没有明确预算，请输入0表示无预算限制",
            ...
            "ja": {
                ...
                "is_beginner": "バスケットボールの初心者ですか？(1年未満の経験)",
                "yes": "はい",
                "no": "いいえ",
                "beginner_questions": "バスケットボールの好み",
                ...
                "recommendations": "推薦されるバスケットボールシューズ",
                ...
                "shoe_details": "シューズの詳細",
                "purchase_link": "購入リンク: ",
                "style_score": "スタイル一致度",
                "next": "次へ",
                "previous": "前へ",
                "get_recommendations": "推薦を取得",
                "restart": "やり直し",
                "progress_basic": "基本情報",
                "progress_experience": "経験",
                "progress_preferences": "偏好",
                "progress_results": "結果",
                "primary_style": "主なプレイスタイル",
                "footer_description": "すべてのバスケットボール愛好者に最適なシューズを",
        ...
        const optionTranslations = {
            "zh": {
                ...
                "not_sure": "不清楚/不知道",
                "other": "其他",
                "michael_jordan": "迈克尔·乔丹",
                "lebron_james": "勒布朗·詹姆斯",
                "kobe_bryant": "科比·布莱恩特",
                "stephen_curry": "斯蒂芬·库里",
                "kevin_durant": "凯文·杜兰特",
                "james_harden": "詹姆斯·哈登",
                ...
                "tough_defense": "强硬的防守",
                "well_rounded": "全面均衡的表现",
                "primary_scorer": "成为主要得分手",
                "occasional_scorer": "偶尔得分，主要配合",
                "learn_basics": "还不确定，先学习基础",
                "defense_expert": "非常重要，想成为防守高手",
                "average_defense": "一般，会尽力但不是重点",
                "offense_focused": "不太感兴趣，更关注进攻",
                "team_oriented": "团队配合，分享球权",
                "individual_oriented": "个人表现，承担责任",
                "1_2_times": "每周1-2次",
                "3_4_times": "每周3-4次",
                "depends": "视情况而定",
                "exercise_entertainment": "锻炼身体，娱乐消遣",
                "join_team": "加入校队或俱乐部",
                ...
                "off_ball": "无球跑动和空切",
                "on_ball_defense": "贴身防守和抢断",
                "blocking_rebounding": "盖帽和篮板",
                "team_defense": "团队防守和协防",
                "defensive_awareness": "防守意识和预判",
                "full_court_pressure": "全场紧逼",
                "fast_paced": "快节奏进攻",
                "half_court": "半场阵地战",
                "physical_play": "身体对抗强",
                "skillful_play": "技巧型打法",
                "team_play_style": "团队配合型",
                "primary_scorer_role": "主要得分手",
                "playmaker": "组织者/控球手",
                ...
                "5_6_times_week": "5-6次",
                "almost_daily": "几乎每天",
                "shooting_accuracy": "投篮准确性",
                "dribbling_driving": "控球和突破",
                "defensive_ability": "防守能力",
                "speed_explosiveness": "速度和爆发力",
                "basketball_iq": "篮球智商和决策",
                "indoor_court": "室内木地板",
                "outdoor_court": "室外水泥地",
                "both_courts": "两者皆有",
                "cushioning": "缓震性能",
                "support_stability": "支撑稳定性",
                "lightweight_flexibility": "轻便灵活性",
                "durability": "耐磨耐用性",
                "traction": "抓地力",
                "breathability": "透气性",
                "nike": "耐克/Nike",
            ...
            "ja": {
                ...
                "not_sure": "分からない",
                "other": "その他",
                "michael_jordan": "マイケル・ジョーダン",
                "lebron_james": "レブロン・ジェームス",
                "kobe_bryant": "コービー・ブライアント",
                "stephen_curry": "スティーブン・カリー",
                "kevin_durant": "ケビン・デュラント",
                ...
                "small_forward": "スモールフォワード",
                "power_forward": "パワーフォワード",
                "center": "センター",
                "fast_breaks": "速いブレークとダンク",
                "accurate_shooting": "正確なシュート",
                "excellent_passing": "優れたパスと組織",
                "tough_defense": "タフなディフェンス",
                "well_rounded": "バランスの取れたパフォーマンス",
                "primary_scorer": "主なスコアラーになる",
                "occasional_scorer": "時々得点し、主に協力する",
                "learn_basics": "まだ確かでなく、基本を学ぶ",
                "defense_expert": "非常に重要で、ディフェンスの達人になりたい",
                "average_defense": "普通、最善を尽くすが重点ではない",
                "offense_focused": "あまり興味がなく、オフェンスに重点を置く",
                "team_oriented": "チームワーク、ボールの共有",
                "individual_oriented": "個人のパフォーマンス、責任を負う",
                "1_2_times": "週1-2回",
                "3_4_times": "週3-4回",
                "depends": "状況次第",
                "exercise_entertainment": "体を鍛え、娯楽",
                "join_team": "学校チームやクラブに加入する",
                "improve_skills": "技術を向上させ、ゲームを楽しむ",
                "professional_player": "プロ選手になる",
                "perimeter_shooting": "ペリメーターシュート（3ポイント、中距離）",
                "drives_dunks": "ドライブとラムダンク",
                "post_play": "ポストプレイ",
                "passing_playmaking": "パスとプレーメーキング",
                "off_ball": "ボールを持たないランとカット",
                "on_ball_defense": "ボールを持つ相手のディフェンスとスティール",
                "blocking_rebounding": "ブロックとリバウンド",
                "team_defense": "チームディフェンスとヘルプディフェンス",
                "defensive_awareness": "ディフェンスの意識と予測",
                "full_court_pressure": "フルコートプレッシャー",
                "fast_paced": "速いペースのオフェンス",
                "half_court": "ハーフコートのポストプレイ",
                "physical_play": "身体的なプレイ",
                "skillful_play": "スキルフルなプレイ",
                "team_play_style": "チームワーク型",
                "primary_scorer_role": "主なスコアラー",
                "playmaker": "プレーメーカー/ボールハンドラー",
                "defensive_anchor": "ディフェンスの中核",
                ...
                "dribbling_driving": "ドリブルとドライブ",
                "defensive_ability": "ディフェンス能力",
                "speed_explosiveness": "スピードと爆発力",
                "basketball_iq": "バスケットボールのIQと意思決定",
                "indoor_court": "屋内の木製フロア",
                "outdoor_court": "屋外のコンクリートコート",
                "both_courts": "どちらも",
                "cushioning": "クッション性",
                "support_stability": "サポートと安定性",
                "lightweight_flexibility": "軽量と柔軟性",
                "durability": "耐久性",
                "traction": "トラクション",
                "breathability": "通気性",
                "nike": "ナイキ/Nike",
                "adidas": "アディダス/Adidas",
                "jordan": "エアジョーダン/Air Jordan",
                "under_armour": "アンダーアーマー/Under Armour",
                "peak": "ピーク",
                "li_ning": "リニン",
                "very_lightweight": "非常に軽い",
        ...
        const defaultShoes = [
            {
                ...
                "foot_type": "正常脚型",
                "court_type": "室内木地板",
                "features": ["缓震性能", "支撑稳定性", "抓地力"],
                "weight": "中等重量",
                "description": "Nike LeBron 20 是勒布朗·詹姆斯的第20代签名战靴，采用创新的Zoom Air科技和React泡沫中底，提供出色的缓震和支撑。适合各种位置的球员，尤其是小前锋和大前锋。",
                "match_score": 95,
            ...
            },
            {
                ...
                "foot_type": "正常脚型",
                "court_type": "室内木地板",
                "features": ["轻便灵活性", "抓地力", "支撑稳定性"],
                "weight": "非常轻便",
                "description": "Adidas Dame 7 是达米安·利拉德的第7代签名鞋，采用Lightstrike中底科技和橡胶外底，提供出色的反应速度和抓地力。适合喜欢快速突破的控球后卫和得分后卫。",
                "match_score": 90,
            ...
            },
            {
                ...
                "brand": "安德玛/Under Armour",
                "price": 1299,
                "style_type": "精准投篮型",
                "position": "控球后卫/得分后卫",
                "foot_type": "正常脚型",
                "court_type": "室内木地板",
                "features": ["轻便灵活性", "缓震性能", "抓地力"],
                "weight": "非常轻便",
        ...
        function validateBasicInfo() {
            ...
            if (!height || !weight || !armSpan || !footType || !favoritePlayer) {
                alert(translations[currentLang]['required_fields'] || '请填写所有必填字段');
                return false;
            }

            if (favoritePlayer === '其他' && !otherPlayer) {
                alert(translations[currentLang]['other_player_required'] || '请输入其他球员名字');
                return false;
            }
        ...
        function analyzeUserStyle() {
            ...
            // 基于用户答案计算风格分数
            // 这些权重是示例性的，可以根据实际情况调整
            if (userAnswers.isBeginner) {
                // 新手风格分析
                if (userAnswers.admireStyle === '全面均衡的表现') styleScores['全能均衡型'] += 30;
                if (userAnswers.admireStyle === '精准投篮') styleScores['精准投篮型'] += 30;
                if (userAnswers.admireStyle === '快速突破和扣篮') styleScores['突破型'] += 30;
                if (userAnswers.admireStyle === '强硬的防守') styleScores['防守型'] += 30;
                
                if (userAnswers.scoringDesire === '成为主要得分手') {
                    styleScores['精准投篮型'] += 15;
                    styleScores['突破型'] += 15;
                }
                ...
                // 非新手风格分析
                if (userAnswers.offensiveStrength === '外线投篮（三分、中投）') styleScores['精准投篮型'] += 30;
                if (userAnswers.offensiveStrength === '突破上篮/扣篮') styleScores['突破型'] += 30;
                if (userAnswers.defensiveStrength === '贴身防守和抢断' || userAnswers.defensiveStrength === '盖帽和篮板') styleScores['防守型'] += 30;
                
                if (userAnswers.courtRole === '全能型球员') styleScores['全能均衡型'] += 25;
                if (userAnswers.courtRole === '主要得分手') {
                    styleScores['精准投篮型'] += 15;
                    styleScores['突破型'] += 15;
                }
                if (userAnswers.courtRole === '防守核心') styleScores['防守型'] += 20;
            }
            ...
            if (position === '控球后卫' || position === '得分后卫') {
                styleScores['精准投篮型'] += 15;
                styleScores['突破型'] += 15;
            } else if (position === '小前锋' || position === '大前锋') {
                styleScores['全能均衡型'] += 20;
            } else if (position === '中锋') {
                styleScores['防守型'] += 15;
            }
            
            // 找出最高分数的风格
            let primaryStyle = '全能均衡型';
            let maxScore = styleScores['全能均衡型'];
        ...
        function createStyleChart(styleScores) {
            ...
            styleChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: translations[currentLang]['style_score'] || '风格匹配度',
        ...
        function findMatchingShoes(userStyle, userAnswers) {
            ...
            defaultShoes.forEach(shoe => {
                ...
                if (userPosition && shoePositions.includes(userPosition)) {
                    matchScore += 5;
                } else if (userPosition && !userPosition.includes('不清楚') && !userPosition.includes('不知道')) {
                ...
                if (userAnswers.footType && shoeFootTypes.includes(userAnswers.footType)) {
                    matchScore += 5;
                } else if (userAnswers.footType && userAnswers.footType !== '无所谓') {
                    mismatches.push(`脚型适应性 (${shoe.foot_type})`);
                }
                
                // 基于场地类型调整分数
                if (userAnswers.courtType && shoe.court_type.includes(userAnswers.courtType)) {
                    matchScore += 5;
                } else if (userAnswers.courtType && userAnswers.courtType !== '两者皆有' && !userAnswers.courtType.includes('不清楚')) {
                ...
                if (userAnswers.shoeBrand && shoe.brand.includes(userAnswers.shoeBrand)) {
                    matchScore += 5;
                } else if (userAnswers.shoeBrand && userAnswers.shoeBrand !== '无所谓') {
                ...
                if (userAnswers.shoeWeight && shoe.weight.includes(userAnswers.shoeWeight)) {
                    matchScore += 5;
                } else if (userAnswers.shoeWeight && userAnswers.shoeWeight !== '无所谓') {
            ...
            return matchingShoes.slice(0, 5); // 返回前5个匹配结果
        }
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full md:w-2/3">
                        ...
                        <div class="flex items-center mb-4">
                            ...
                            <span class="bg-primary/10 text-primary text-sm font-semibold px-2.5 py-0.5 rounded">匹配度: ${shoe.matchScore}%</span>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <p class="text-sm font-medium mb-1">主要特性:</p>
                        ...
                        ${shoe.mismatches && shoe.mismatches.length > 0 ? `
                            <div class="mb-4">
                                <p class="text-sm font-medium mb-1 text-yellow-600">${translations[currentLang]['mismatch_details'] || '不匹配细节:'}</p>
                                <p class="text-sm text-yellow-600">${shoe.mismatches.join(', ')}</p>
                            </div>
                        ` : ''}
                        <div class="mb-4">
                            <p class="text-sm font-medium mb-1">简介:</p>
        ...
        function changeLanguage(lang) {
            if (translations[lang]) {
                ...
                if (styleChart) {
                    ...
                    styleChart.options.plugins.legend.labels.text = translations[lang]['style_score'] || '风格匹配度';
                    styleChart.update();
                }
